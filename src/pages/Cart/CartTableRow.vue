...
export default {
  ...
  computed: {
    ...
    totalPrice() {
      const number = this.quantity * this.product.caloriesPerServing;
  ...
  <tr>
    <td>
      <div style="aspect-ratio: 1/1; width: 5rem; border-radius: 0.5rem; overflow: hidden;">
        <img style="object-fit: cover; width: 100%; height: 100%;" :src="product.image">
      </div>
    </td>
    <td>
      ...
      <p style="font-size: 0.75rem;">
        Calories: {{ product.caloriesPerServing }} kcal
      </p>
    </td>
    <td>
    ...
    <td class="price">
      <button type="button" class="secondary outline" @click="$emit('delete')">
        🗑️
      </button>
    </td>
  </tr>
